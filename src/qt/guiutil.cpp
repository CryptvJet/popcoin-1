...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("popcoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("popcoin://"))
    {
        uri.replace(0, 11, "popcoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "POPCoin.lnk";
}
