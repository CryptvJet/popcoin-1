...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:9222", "127.0.0.1", 9222));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9333", "127.0.0.1", 9222));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9333", "::ffff:127.0.0.1", 9222));
    BOOST_CHECK(TestSplitHost("[::]:9333", "::", 9222));
    BOOST_CHECK(TestSplitHost("::9222", "::9222", -1));
    BOOST_CHECK(TestSplitHost(":9222", "", 9222));
    BOOST_CHECK(TestSplitHost("[]:9222", "", 9222));
